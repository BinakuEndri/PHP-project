...
if (!empty($_POST["id"])) {
    ...
    $complainTenant = $complainn["Sender_ID"];
    $complainLandlord = $complainn["Reciver_ID"];
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="../../../PHP/landlord/complainReply.php" id="mainForm">
                <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                <textarea id="basic-icon-default-message" class="form-control"
                                    ...
                                    placeholder="Hi, Do you want to reply  to <?= $tenant_name ?>"
                                    aria-label="Hi, Do you want to reply  to  <?= $tenant_name ?>"
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                <textarea id="basic-icon-default-messagee" class="form-control"
                                    ...
                                    aria-label="Hi, Do you want to reply  to  <?= $tenant_name ?>" value="<?= $complainReply ?>"
                                    aria-describedby="basic-icon-default-message2" name="reply"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        $(document).ready(function () {
                            ...
                            $("#updateButton").click(function () {
                                $("#mainForm").attr("action", "../../../PHP/landlord/updateComplainReply.php");
                                $("#updateButton").attr("type", "submit");
                                $("#updateButton").click();

                            });
                            $("#deleteButton").click(function () {
                                $("#mainForm").attr("action", "../../../PHP/landlord/deleteComplainReply.php");

...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['oldPassword']) && empty($_POST['newPassword'])) {
        ...
        header("Location: ../../dashboardTemplate/html/tenant/change-password.php");
    }
    ...
    if ($oldPassword != $password) {
        ...
        if ($query_run) {
            ...
            header("Location: ../../dashboardTemplate/html/tenant/edit-profile.php");
        } else {

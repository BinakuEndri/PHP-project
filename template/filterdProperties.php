...
if (!isset($_POST['theSubmit'])) {
    ...
    if (isset($_POST["keyword"]) && isset($_POST["minPrice"]) && isset($_POST["maxPrice"]) && isset($_POST["minSize"]) && isset($_POST["maxSize"])) {
        ...
        Property_City = '$city' OR (Property_Address LIKE '%$keyword%' OR Property_Type LIKE '%$keyword%' OR Property_Number LIKE '%$keyword%')
        AND RentAmount BETWEEN $minPrice AND $maxPrice
                    ...
                    <div class="col-md-12 clear" id="theDiv">
                        <div id="list-type" class="proerty-th">
                            <?php // make a for each of all properties 
                                while ($prope = mysqli_fetch_assoc($result)) {

              ...
              ?>
                                                      <div class="card">
                                                        <div class="card-body">
                                                          ...
                                                          <p class="mb-4">Enter new password and it will be reseted</p>
                                                          <form id="formAuthentication" class="mb-3" action="../../PHP/resetPassword.php" method="POST">
                                                          <div class="mb-3 form-password-toggle">
                                                            ...
                                                            <div class="mb-3 form-password-toggle">
                                                              ...
                                                              <div class="input-group input-group-merge">
                                                                <input type="password" id="password" class="form-control" name="pwd-repeat"
                                                                  placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                                  aria-describedby="password" />
                                                                <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                                              </div>
                                                            </div>
                                                            <button class="btn btn-primary d-grid w-100" name="reset-password" type="submit">Reset Password</button>
                                                          </form>
                                                        </div>
                                                      </div>
                                                            <?php

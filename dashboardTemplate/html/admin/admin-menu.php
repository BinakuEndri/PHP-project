        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">LandLords</span>
            </li>
            <li class="menu-item">
              <a href="admin-landlord.php" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Landlords</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="admin-landlord-add.php" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Add Landlord</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="admin-tenant.php" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Tenants</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="admin-tenant-add.php" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
            ...
            <li class="menu-item">
              <a href="admin-property.php" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Properties</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="admin-property-add.php" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Add Property</div>
              </a>
            </li>
            <li class="menu-header small text-uppercase">

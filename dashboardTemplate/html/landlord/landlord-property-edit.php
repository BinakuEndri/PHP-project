...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Properites/ </span>Edit Property:
        <?php echo $number ?>
    </h4>
    ...
    <div class="row">
        <div class="col">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="../../../PHP/landlord/landlord-property-edit.php" method="Post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">

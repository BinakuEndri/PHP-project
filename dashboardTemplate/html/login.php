...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (isset($_POST['g-recaptcha-response'])) {
    $secretkey = "6LdAqhEmAAAAAMmCo-aXNMLYT8azyTf5x6Wd1XkR";
    ...
    if (json_decode($response)->success) {
      ...
      if (!isset($_POST["username"]) || !isset($_POST["password"])) {
        ...
        $_SESSION["EmptyFieldsError"] = "Please fill all the fields";
      ...
      $query = sprintf(
        "SELECT * FROM owner WHERE Owner_Username = '%s'",
        $con->real_escape_string($_POST["username"])
      );

      $query1 = sprintf(
        "SELECT * FROM tenant WHERE Tenant_Username = '%s'",
        $con->real_escape_string($_POST["username"])
      );

      $query2 = sprintf(
        "SELECT * FROM user WHERE Admin_Username = '%s'",
        $con->real_escape_string($_POST["username"])
      );
      ...
      $tenant = $result1->fetch_assoc();
      $admin = $result2->fetch_assoc();


      if ($landlord) {
        if (password_verify($_POST["password"], $landlord["Owner_Password"])) {
          session_start();
      ...
      $_SESSION["Chapta_Error"] = "You are not verified";
      header("Location: login.php");
      exit();
      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          if (isset($_SESSION["Login_Error"])) {
            ...
            showMessage($_SESSION["Login_Error"], "danger");
            unset($_SESSION["Login_Error"]);

          }
          ?>
          <?php
          if (isset($_SESSION["Chapta_Error"])) {

            showMessage($_SESSION["Chapta_Error"], "danger");
            unset($_SESSION["Chapta_Error"]);

          }
          ?>
          <?php
          if (isset($_SESSION["EmptyFieldsError"])) {

            showMessage($_SESSION["EmptyFieldsError"], "danger");
            unset($_SESSION["EmptyFieldsError"]);
            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" method="POST">
                ...
                <div class="mb-3 justify-content-center">
                  <div class="g-recaptcha" data-sitekey="6LdAqhEmAAAAAOHbMMvOIOKJC2FhaURgn9hZMg2K"></div>
                </div>
